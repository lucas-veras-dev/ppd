...
<body>
    ...
    <div class="bg-dark bg-gradient text-light p-3 text-uppercase d-flex flex-column justify-content-center align-items-center">
        <img id="homeImg" src="../../assets/images/logo.png">
        ...
        <div class="row p-3">
            <div class="col-12">
                <div class="row row-cols-1 row-cols-md-3 g-4">
                    <div class="col">
                        <div class="card h-100">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">Desaparecida perto do atacadão da Ceilândia norte.</p>
                            </div>
                    ...
                    <div class="col">
                        <div class="card h-100">
                            <img src="../../assets/images/pessoas/pessoas-com-dentes-grandes.jpg" class="card-img-top card-img-desaparecidos" alt="...">
                            <div class="card-body">
                                <h5 class="card-title">Pedro</h5>
                                <p class="card-text">Desaparecido na estação do metrô de Águas Claras.</p>
                            </div>
                            <div class="card-footer">
                                <small class="text-body-secondary">Última atualização há 30 minutos</small>
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="card h-100">
                            <img src="../../assets/images/pessoas/pexels-justin-shaifer-1222271.jpg" class="card-img-top card-img-desaparecidos" alt="...">
                            <div class="card-body">
                                <h5 class="card-title">Lucas</h5>
                                <p class="card-text">Desaparecido no campo de futebol de Taguatinga.</p>
                            </div>
                            <div class="card-footer">
                                <small class="text-body-secondary">Última atualização há 15 minutos</small>
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="card h-100">
                            <img src="../../assets/images/pessoas/site-vacinacao-26-anos.png" class="card-img-top card-img-desaparecidos" alt="...">
                            <div class="card-body">
                                <h5 class="card-title">Paulo</h5>
                                <p class="card-text">Desaparecido depois da saida do trabalho.</p>
                            </div>
                            <div class="card-footer">
                                <small class="text-body-secondary">Última atualização há 27 minutos</small>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="bg-dark bg-gradient">
        <footer class="py-3 my-4">
            <ul class="nav justify-content-center border-bottom pb-3 mb-3">
                ...
                <li class="nav-item"><a href="/desaparecido/cadastrar" class="nav-link px-2 text-light">Cadastrar
                        Desaparecido</a></li>
            ...
            <p class="text-center text-light">&copy; 2023 PDD, procura por pessoas desaparecidas</p>
        </footer>
    </div>
    ...
    <!-- fontawesome 6.4.2 -->
    <script src="https://kit.fontawesome.com/3584291ce8.js" crossorigin="anonymous"></script>
</body>
